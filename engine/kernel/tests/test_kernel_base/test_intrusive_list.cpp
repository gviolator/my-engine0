...
namespace my::test
{
  struct MyValue : IntrusiveListNode<MyValue>
  {
    uint64_t value;
    MyValue()
    {
  ...
  class Test_IntrusiveList : public ::testing::Test
  {
  ...
  protected:
    ...
    {
      const CheckGuardThrowOnFailure checkGuard;
  ...
  /// <param name=""></param>
  /// <returns></returns>
  TEST_F(Test_IntrusiveList, CheckEmptiness)
  {
  ...
  /// <param name=""></param>
  /// <returns></returns>
  TEST_F(Test_IntrusiveList, CheckAddingRemovingElement)
  {
    const CheckGuardThrowOnFailure checkGuard;
    {
      IntrusiveList<MyValue> originList;
  ...
  /// <param name=""></param>
  /// <returns></returns>
  TEST_F(Test_IntrusiveList, CheckErasers)
  {
    IntrusiveList<MyValue> originList;
  ...
  /// <param name=""></param>
  /// <returns></returns>
  TEST_F(Test_IntrusiveList, CheckDoubleAdding)
  {
    const CheckGuardThrowOnFailure checkGuard;
    IntrusiveList<MyValue> originList;
  ...
  /// <param name=""></param>
  /// <returns></returns>
  TEST_F(Test_IntrusiveList, CheckMiddleRemoving)
  {
    const CheckGuardThrowOnFailure checkGuard;
    MyValue val1;
    MyValue val3;
  ...
  ///
  /// </summary>
  TEST_F(Test_IntrusiveList, Move)
  {
    MyValue val1;
    MyValue val2;
