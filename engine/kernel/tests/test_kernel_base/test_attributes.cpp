...
namespace my::test
{
  namespace
  {
    MY_DEFINE_ATTRIBUTE_(TestAttrib0);
    MY_DEFINE_ATTRIBUTE_(TestAttrib1);
    MY_DEFINE_ATTRIBUTE_(TestAttrib2);
    MY_DEFINE_ATTRIBUTE_(TestAttrib3);
    MY_DEFINE_ATTRIBUTE_(TestAttribX);
    MY_DEFINE_ATTRIBUTE_(TestAttribExt1);
    MY_DEFINE_ATTRIBUTE_(TestAttribExt2);

    MY_DEFINE_ATTRIBUTE(AttribInherit0, "", meta::AttributeOptions::Inherited)
    MY_DEFINE_ATTRIBUTE(AttribInherit1, "", meta::AttributeOptions::Inherited)
    ...
    MY_CLASS_ATTRIBUTES_EXT(MyType1,
    ...
    MY_CLASS_ATTRIBUTES_EXT(MyType2,
                            CLASS_ATTRIBUTE(TestAttrib0, std::string_view{"Attrib0"}),
                            CLASS_ATTRIBUTE(TestAttrib1, 75))

    class MyType_Inherit1 : public MyType1
    {
      MY_CLASS_BASE(MyType1)
