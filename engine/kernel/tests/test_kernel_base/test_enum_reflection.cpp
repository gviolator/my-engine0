...
MY_DECLARE_ENUM(TestEnumOld, Value0, Value1, Value2, Value3)
...
namespace my::test
{
    ...
    */
    ...
    {
        const my::IEnumRuntimeInfo& enumInfo = EnumTraits<ResourceReturnType>::getRuntimeInfo();
    ...
    */
    ...
    {
        EXPECT_EQ(my::string("Value0"), enum_to_str(TestEnumOld::Value0));
        EXPECT_EQ(my::string("Value1"), enum_to_str(TestEnumOld::Value1));
        EXPECT_EQ(my::string("Value2"), enum_to_str(TestEnumOld::Value2));
        EXPECT_EQ(my::string("Value3"), enum_to_str(TestEnumOld::Value3));

        // TODO: Dubious operation: should return an error, not a string:
        EXPECT_EQ(my::string("Unknown value for Enum: TestEnumOld"), enum_to_str(TestEnumOld::NoValue));

        EXPECT_EQ(my::string::format(u8"{}", TestEnumOld::Value0), u8"Value0");
        EXPECT_EQ(my::string::format(u8"{}", TestEnumOld::Value1), u8"Value1");
        EXPECT_EQ(my::string::format(u8"{}", TestEnumOld::Value2), u8"Value2");
        EXPECT_EQ(my::string::format(u8"{}", TestEnumOld::Value3), u8"Value3");
