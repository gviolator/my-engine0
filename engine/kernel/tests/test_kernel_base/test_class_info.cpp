...
namespace my::test
{
    namespace
    {
        ...
        struct Base3 : Base2,
                       virtual Base0
        {
            MY_CLASS_BASE(Base2, Base0)
        };

        struct MyClass : Base1,
                         Base3
        {
            MY_CLASS_BASE(Base1, Base3)
        };
        ...
        {
            MY_CLASS_BASE(TypeWithNamedFields)
        };

        class InheritFields2 : public InheritFields1
        {
            MY_CLASS_BASE(InheritFields1)
        ...
        {
        public:
            MY_CLASS_BASE(TypeWithFields, TypeWithNamedFields)
        ...
        {
            MY_CLASS_BASE(TypeWithMethods, TypeWithNamedMethods);
            MY_CLASS_METHODS(
