...
TEST_F(TestPropertyContainer, ReadPropsFromJson)
{
    ...
    EXPECT_TRUE(m_props->contains("prop_int1"));
    EXPECT_TRUE(m_props->contains("prop_int2"));
    EXPECT_TRUE(m_props->contains("prop_str"));
    EXPECT_TRUE(m_props->contains("section_0"));
}
