...
class TestAllocator final : public AllocatorWithMemResource<TestAllocator>
{
    MY_REFCOUNTED_CLASS(TestAllocator, IAllocator)
public:
    ...
    void* realloc(void* ptr, size_t size, size_t) override
    {
        return ::realloc(ptr, size);
    }

    void free(void* ptr, size_t, size_t) override
    {
        ::free(ptr);
    }
...
private:
    AllocatorPtr m_customAllocator;
};
